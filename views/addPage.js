...
module.exports = () =>
  ...
  <div class="form-group">
    ...
    <div class="form-group">
      ...
      <div class="col-sm-10">
        <textarea id="title" name="content"  class="form-control"> </textarea>
      </div>
    </div>

    <div class="form-group">
      <label for="title" class="col-sm-2 control-label">Page Status (Check if Closed)</label>
      <div class="col-sm-10">
        <input id="title" name="status" type="checkbox" value="closed" class="form-control"/>
      </div>
    </div>
